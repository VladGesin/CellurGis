...
const Navbarcomponent =()=> {
  ...
  <Navbar bg="dark" variant="dark" dir="rtl">
    ...
    <Nav >
      <NavLink to="/Workspace" activeClassName='active' className=' links-container'>תוכנית עבודה</NavLink>
      <NavLink to="/Mappage"activeClassName='active' className=' links-container'> מפה כיסויים</NavLink>
